...
Return no candidate when the changed behavior creates no plausible security-boundary regression. Missing context is not proof of safety; record it in coverage gaps.
