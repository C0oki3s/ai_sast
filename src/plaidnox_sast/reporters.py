        ...
        entries.append(
            {
                ...
                "properties": {
                    ...
                    "routeNeedsCrossFile": finding.metadata.get("route_needs_cross_file"),
                    "routeNeedsStateReconstruction": finding.metadata.get("route_needs_state_reconstruction"),
                    "routeNeedsExternalSemantics": finding.metadata.get("route_needs_external_semantics"),
                    "routeNeedsEnvironmentContext": finding.metadata.get("route_needs_environment_context"),
                    "routeNeedsDeepFalsification": finding.metadata.get("route_needs_deep_falsification"),
                    "routeAnalysisComplexity": finding.metadata.get("route_analysis_complexity"),
                    "routeModelTier": finding.metadata.get("route_model_tier"),
                    "routeNeedsDeepHunt": finding.metadata.get("route_needs_deep_hunt"),
                    "classifications": classifications,
                },
            }
        )
