...
Use separate, bounded searches when one broad expression could truncate results or obscure application coverage. Every query must name its coverage targets and why its matches are needed. Searches locate evidence; they never classify a vulnerability.
