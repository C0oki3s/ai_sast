...
21. **Next:** compare invalidation and carry-forward behavior against a real disposable PostgreSQL instance and add independent Deep Hunt gate coverage for the seeded root before changing Graphify defaults. Do not run an acceptance scan without an explicit user request.
